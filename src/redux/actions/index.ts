...
export const setTokenAction = (token: string) => ({ type: SET_TOKEN, payload: token });
...
export const showAddLetturaModalAction = (id?: number) => ({ type: SHOW_ADD_LETTURA_MODAL, payload: id });
export const hideAddLetturaModalAction = () => ({ type: HIDE_ADD_LETTURA_MODAL });
export const showDeleteLetturaModalAction = (id?: number) => ({ type: SHOW_DELETE_LETTURA_MODAL, payload: id });
export const hideDeleteLetturaModalAction = () => ({ type: HIDE_DELETE_LETTURA_MODAL });
export const showAddOneriModalAction = (id?: number) => ({ type: SHOW_ADD_ONERI_MODAL, payload: id });
export const hideAddOneriModalAction = () => ({ type: HIDE_ADD_ONERI_MODAL });
export const showDeleteOneriModalAction = (id?: number) => ({ type: SHOW_DELETE_ONERI_MODAL, payload: id });
export const hideDeleteOneriModalAction = () => ({ type: HIDE_DELETE_ONERI_MODAL });
export const showAddDispacciamentoModalAction = (id?: number) => ({
  type: SHOW_ADD_DISPACCIAMENTO_MODAL,
  payload: id,
});
export const hideAddDispacciamentoModalAction = () => ({ type: HIDE_ADD_DISPACCIAMENTO_MODAL });
export const showDeleteDispacciamentoModalAction = (id?: number) => ({
  type: SHOW_DELETE_DISPACCIAMENTO_MODAL,
  payload: id,
});
export const hideDeleteDispacciamentoModalAction = () => ({ type: HIDE_DELETE_DISPACCIAMENTO_MODAL });
export const showAddClienteModalAction = (id?: number) => ({ type: SHOW_ADD_CLIENTE_MODAL, payload: id });
export const hideAddClienteModalAction = () => ({ type: HIDE_ADD_CLIENTE_MODAL });
export const showDeleteClienteModalAction = (id?: number) => ({ type: SHOW_DELETE_CLIENTE_MODAL, payload: id });
export const hideDeleteClienteModalAction = () => ({ type: HIDE_DELETE_CLIENTE_MODAL });
export const showAddFornituraModalAction = (id?: string) => ({ type: SHOW_ADD_FORNITURA_MODAL, payload: id });
export const hideAddFornituraModalAction = () => ({ type: HIDE_ADD_FORNITURA_MODAL });
export const showDeleteFornituraModalAction = (id?: string) => ({ type: SHOW_DELETE_FORNITURA_MODAL, payload: id });
